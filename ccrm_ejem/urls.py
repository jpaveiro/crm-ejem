...
urlpatterns = [
    ...
    path('vendedor/vendas/criar/', views.vendedor_venda_criar_view, name='vendedor-venda-criar'),
    path('vendedor/vendas/<int:pk>/editar/', views.vendedor_venda_editar_view, name='vendedor-venda-editar'),
    path('vendedor/vendas/<int:pk>/excluir/', views.vendedor_venda_excluir_view, name='vendedor-venda-excluir'),
    path('vendedor/produtos/', views.vendedor_produtos_view, name='vendedor-produtos'),
